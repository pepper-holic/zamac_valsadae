...
| # | 항목 | 비고 | 상태 |
|---|---|---|---|
| 31 | 이용약관 (Terms of Service) | 전자상거래법상 유료 서비스는 필수 | [x] 초안 작성 (2026-08-09) — `docs/pages/terms-of-service.md`, [T.B.D] 항목: 사업자 정보, 요금 조항, 관할 법원 |
| 32 | 개인정보처리방침 (Privacy Policy) | 개인정보보호법상 필수 | [x] 초안 작성 (2026-08-09) — `docs/pages/privacy-policy.md`, [T.B.D] 항목: 수집 항목, 보유기간, 위탁 업체, 책임자 |
| 33 | 환불 안내 (Refund Policy) | 구독/과금 방식이 정해져야 조건 확정 가능 | [x] 초안 작성 (2026-08-09) — `docs/pages/refund-policy.md`, [T.B.D] 항목: 구독 주기, 환불 제한 사유, 처리 기간 |
| 34 | 회사 소개 + 사업자 정보 푸터 | 대표자/사업자등록번호/통신판매업신고번호/주소/연락처 | [x] 초안 작성 (2026-08-09) — `docs/pages/company.md`, [T.B.D] 항목: 사업자 정보 표 전체 |
| 35 | 가격 정책 페이지 | 플랜 구조가 사업 결정 사항 | [x] 초안 작성 (2026-08-09) — `docs/pages/pricing.md`, [T.B.D] 항목: 플랜명/가격/한도, 과금 단위 |
| 36 | 다운로드 페이지 | OS별 배포판 | [x] 작성 (2026-08-09) — `docs/pages/download.md`. Windows는 실제 내용(포터블 설치 + `.exe`), macOS/Ubuntu는 [T.B.D](빌드 자체가 없음) |
| 37 | 로그인/체험하기 CTA | 클라우드 계정 시스템 필요 — 콘텐츠가 아니라 기능 | [x] 요구사항 메모 작성 (2026-08-09) — `docs/pages/login-signup.md` (실제 UI는 만들지 않음, 인증 방식·구현체 등 결정 필요 항목만 정리) |
| 38 | 데이터 보호 안내 페이지 | 업로드한 영상/오디오가 서버에서 어떻게 저장·삭제되는지 설명 | [x] 완료 (2026-08-09) — `HelpModal`에 "데이터 보호" 섹션 추가 |
| 39 | 인사이트/사용법 배우기(콘텐츠) | 블로그류 콘텐츠 | [x] 초안 작성 (2026-08-09) — `docs/pages/learn.md`(실제 내용, `HelpModal`과 동기화 필요), `docs/pages/insights.md`([T.B.D], 콘텐츠 없음) |
| 40 | 커뮤니티/공지사항 | 사용자 규모가 어느 정도 있어야 의미 있음 | [x] 초안 작성 (2026-08-09) — `docs/pages/community.md`([T.B.D], 채널 미정), `docs/pages/notices.md`(첫 공지 시드) |

**주의점**: [T.B.D]로 표시된 값(사업자등록번호, 통신판매업신고번호, 요금제 숫자, 관할 법원,
개인정보보호책임자 등)은 실제 사업자 등록·요금제 설계가 끝나야 채울 수 있어 초안에 그대로
남겨뒀습니다. **이용약관·개인정보처리방침·환불안내는 시행 전 반드시 법률 검토를 받으세요**
— 여기 작성된 조항은 표준 뼈대일 뿐 법적 효력을 보장하지 않습니다.
