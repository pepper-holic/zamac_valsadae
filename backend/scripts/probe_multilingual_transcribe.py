...
Usage:
    python scripts/probe_multilingual_transcribe.py <media_path> [--model small]
    python scripts/probe_multilingual_transcribe.py <media_path> --dual --languages ko,en
"""
...
logger = logging.getLogger("probe_multilingual_transcribe")
...
def _run_pass(
    ...
    device = whisper_service._detect_device()  # noqa: SLF001 - internal reuse for a dev script
    model = whisper_service._get_model_on_device(model_size, device)  # noqa: SLF001
